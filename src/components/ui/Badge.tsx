...
export function Badge({ children, tone = 'neutral', className }: BadgeProps) {
  return (
    <span
      className={cn(
        'inline-flex items-center gap-1.5 border border-edge px-2 py-0.5 font-mono text-[11px] font-bold uppercase tracking-[0.04em]',
        TONES[tone],
        className,
      )}
    >
